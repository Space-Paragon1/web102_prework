...
const unfundedString = `We have ${numUnfunded} unfunded ${numUnfunded === 1 ? "game" : "games"}.`;


// create a new DOM element containing the template string and append it to the description container
const paragraph = document.createElement("p");
paragraph.innerHTML = unfundedString;
...
runnerUpGameName.innerText = runnerUpGame.name;
